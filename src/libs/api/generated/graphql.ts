...
export type MessagePostMutation = {
	__typename?: 'Mutations';
	MessagePost?: {
		__typename?: 'MessageEnum';
		messageId: string;
...
export type MessagesFetchLatestQuery = {
	__typename?: 'Queries';
	MessagesFetchLatest?: Array<{
		__typename?: 'MessageEnum';
		messageId: string;
		text: string;
		datetime: any;
...
export type MessagesFetchMoreQuery = {
	__typename?: 'Queries';
...
export const MessagePostDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'MessagePost' },
			variableDefinitions: [
				{
					...
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'ChannelId' } },
					},
				},
				{
					kind: 'VariableDefinition',
				...
				},
				{
					...
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'UserId' } },
					},
				},
			],
			selectionSet: {
...
} as unknown as DocumentNode<MessagePostMutation, MessagePostMutationVariables>;
export const MessagesFetchLatestDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'MessagesFetchLatest' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'channelId' } },
...
} as unknown as DocumentNode<MessagesFetchLatestQuery, MessagesFetchLatestQueryVariables>;
export const MessagesFetchMoreDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
...
} as unknown as DocumentNode<MessagesFetchMoreQuery, MessagesFetchMoreQueryVariables>;
